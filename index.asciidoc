...
then select the Vaadin archetype (com.vaadin:vaadin-archetype-application://<newest Vaadin version>). Set your group and
artifact id and your package to your liking. (I used org.vaadin, spring.tutorial and org.vaadin.spring.tutorial respectively)
